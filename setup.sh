...
version=1.0.0
task_context_dir=task_contexts
...
check_structure() {
    ...
    if [[ ! -d "task_contexts" ]]; then
        log_warning "task_contexts directory missing"
        mkdir -p task_contexts
    fi
...
## Project Structure
- task_contexts/: $(test -d task_contexts && echo "✅ Present" || echo "❌ Missing")
...
main() {
    ...
    echo "4. Start your first task and create task context files"
    echo ""
    echo -e "${BLUE}Files Created:${NC}"
    echo "📁 task_contexts/          - Task-specific context files"
...
case "${1:-}" in
    --help|-h)
        ...
        echo "  - Project structure (task_contexts, scripts)"
